=== eCommerce Product Catalog Plugin for WordPress by impleCode ===
...
eCommerce Product Catalog is a beautiful, easy-to-use, 100% responsive and free product catalogue plugin for WordPress ecommerce or simple product catalog website with request a quote functionality. 
...
Add as many products to the catalog as needed. Your catalog can have 10, 100, 1000, 10 000, 100 000 or more products. The product display will be divided into pages.
...
* set colors of various product catalog elements on product page or product display
...
The following list shows some of the examples of successfull eCommerce Product Catalog implementation:
