...
function frontend_scripts() {
	if ( !is_admin() ) {
		if ( is_lightbox_enabled() && is_ic_product_gallery_enabled() ) {
			...
			wp_register_script( 'al_product_scripts', AL_PLUGIN_BASE_PATH . 'js/product.min.js?' . filemtime( AL_BASE_PATH . '/js/product.min.js' ), array( 'jquery', 'colorbox' ) );
		} else {
			wp_register_script( 'al_product_scripts', AL_PLUGIN_BASE_PATH . 'js/product.min.js?' . filemtime( AL_BASE_PATH . '/js/product.min.js' ), array( 'jquery' ) );
		}
	}
}
